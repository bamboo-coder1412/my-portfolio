        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                I build production LLM applications and AI agents — retrieval
                systems, tool-driven workflows, structured outputs, evaluation
                datasets, and human-in-the-loop approval.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                I design backend services and full-stack systems — secure
                APIs, background jobs, integrations, and cloud infrastructure
                that keep AI workloads reliable in production.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
